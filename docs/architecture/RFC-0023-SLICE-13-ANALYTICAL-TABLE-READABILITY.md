...
- Added a reusable table-text wrapper in [risk-table-text.tsx](C:/Users/Sandeep/projects/lotus-workbench/src/apps/performance/components/risk/risk-table-text.tsx).
- Updated [risk-analytical-table.tsx](C:/Users/Sandeep/projects/lotus-workbench/src/apps/performance/components/risk/risk-analytical-table.tsx) to accept React nodes in cells so panels can render controlled table text.
- Updated [risk-rolling-window-detail.tsx](C:/Users/Sandeep/projects/lotus-workbench/src/apps/performance/components/risk/risk-rolling-window-detail.tsx):
  - shorter table headers
  - clamped review-note cell rendering
- Updated [risk-attribution-panel.tsx](C:/Users/Sandeep/projects/lotus-workbench/src/apps/performance/components/risk/risk-attribution-panel.tsx):
  - shorter table headers
  - truncated group-cell rendering
- Tightened the corresponding table text styles in [globals.css](C:/Users/Sandeep/projects/lotus-workbench/src/app/globals.css).
