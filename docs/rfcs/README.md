...
| --- | --- | --- | --- |
| RFC-0001 | lotus-manage-First Proposal Simulation Screen | IMPLEMENTED | `docs/rfcs/RFC-0001-dpm-first-proposal-simulation-screen.md` |
...
| RFC-0098 | DPM Mandate Command Center Experience | IN PROGRESS - RFC-0038 COMMAND-CENTER COCKPIT, RFC-0039 CONSTRUCTION LAB, RFC-0040 PROOF-PACK PANEL, RFC-0040/RFC-0041/RFC-0042 PORTFOLIO-MEMORY PANEL, RFC-0041 REBALANCE-WAVE PANEL WITH CAMPAIGN-DEFINITION LIST, LIFECYCLE-EVIDENCE, PREVIEW-READINESS, LAUNCH-HISTORY, AND READY-GATED LAUNCH RENDERING, AND RFC-0042 OUTCOME PANEL IMPLEMENTED ON `/workbench/{portfolioId}`, CANONICAL LIVE MEMORY/WAVE PROOF PENDING | `docs/rfcs/RFC-0098-dpm-mandate-command-center-experience.md` |
