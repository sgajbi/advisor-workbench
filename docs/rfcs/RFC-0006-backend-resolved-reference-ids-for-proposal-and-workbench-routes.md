...
- Command-center and route shortcuts hardcode portfolio IDs that are not reconciled with lotus-core/lotus-manage seeded datasets.
...
2. Resolve default proposal and portfolio references from backend data providers (lotus-gateway contracts) at runtime.
...
- Strengthens UI/lotus-gateway contract boundaries by making backend the source of navigable entity identity.
...
- Slightly increases lotus-gateway dependency for route rendering decisions.
- Migration may require updates to UI tests currently keyed to static IDs.

## High-Level Implementation Approach

1. Introduce lotus-gateway-backed reference resolver hooks for "default proposal" and "default portfolio".
