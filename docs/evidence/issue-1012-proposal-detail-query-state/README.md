...
The extracted 227-line query-state owner contains the four source queries, serial persisted-command
...
- `tests/integration/proposal-detail-view.test.tsx` proves source-confirmed lifecycle and version
  ...
  agreement, malformed-success fencing, non-advancing replay rejection, and retained confirmed
  version evidence on revisit.
