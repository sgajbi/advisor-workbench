...
| Record | Purpose |
| --- | --- |
| [Product architecture blueprint](product-architecture-blueprint.md) | Proposed target-state composition and responsibility model; not current implementation proof |
