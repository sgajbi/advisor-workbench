...
export const ADVISORY_JOURNEY_DEFINITIONS: AdvisoryJourneyDefinition[] = [
  ...
  },
  {
    ...
    detail: "Client rationale",
    title: "Client Discussion Pack",
    description: "Advisor-reviewed rationale and client-ready discussion posture.",
    primaryDecision: "Is the proposal ready to discuss with the client?",
    nextAction: "Prepare the client discussion pack after all gates pass.",
