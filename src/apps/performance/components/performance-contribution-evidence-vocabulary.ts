...
> = {
  ...
  realized_pnl: componentPnlEntry("realised gains and losses"),
  realized_capital_pnl: componentPnlEntry("realised capital gains and losses"),
  realized_fx_pnl: componentPnlEntry("realised currency gains and losses"),
