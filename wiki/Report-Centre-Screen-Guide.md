...
| Single-request refresh unavailable | The last source-confirmed request rows remain visible with an explicit current-evidence warning | Use **Try again** or allow the next bounded refresh; retained evidence is not presented as current |
