...
| Performance and risk review             | `/performance` route modes                                          | Gateway performance summary, detail, horizon-comparison, attribution, risk, advisor-brief, and evidence APIs                                                                                                                                                                                                                            | Supported for selected-portfolio benchmark-aware return, return-path, multi-horizon, contribution, attribution, risk, internal brief, and calculation-evidence review according to source capability. Performance selections are transactional: prior figures retain their original source-confirmed labels while a requested scope is pending or failed, and summary, detail, controls, and URL become current together only after matching source success. Historical attribution independently distinguishes source failure, access restriction, confirmed absence, one exact observation, and a multi-observation trend; a chart requires at least two observations and exact retry re-contacts source authority. Workbench does not calculate performance, infer missing analytics, recommend trades, publish client reports, or claim official performance sign-off. |
