...
| Lotus Idea opportunity triage           | `/recommendations?mode=opportunities`                               | Gateway `/api/v1/ideas/review-queues/advisor` and `/api/v1/ideas/candidates/{candidate_id}`                                                                                                                                                                                                                                             | Implemented as a Gateway-backed Workbench surface over Lotus Idea-owned advisor review queue candidates. Workbench passes the active portfolio as caller entitlement scope, renders Idea-owned rank, score, priority, review posture, source-signal ids, reason codes, durable-storage posture, policy version, and supported-feature promotion posture, and links only to source-safe Gateway candidate detail. It does not rerank candidates, clone Idea scoring, infer downstream conversion, create proposals automatically, grant suitability or execution authority, or promote Lotus Idea as a supported feature before canonical browser proof, data-product certification, and `lotus-idea` supported-feature evidence exist. |
