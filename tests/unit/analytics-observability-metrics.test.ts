...
describe("analytics UI observability metrics", () => {
  ...
  it("keeps the supported Workbench observed-surface registry explicit", () => {
    expect(
      ...
      ["workbench.dpm-command-center", "wave-detail", "dpm.waves.get"],
      ["workbench.dpm-command-center", "wave-items", "dpm.waves.items"],
      [
        "workbench.dpm-command-center",
        "wave-source-check",
        "dpm.waves.source-check",
      ],
      ["workbench.dpm-command-center", "wave-simulate", "dpm.waves.simulate"],
      ["workbench.dpm-command-center", "wave-approve", "dpm.waves.approve"],
      ["workbench.dpm-command-center", "wave-stage", "dpm.waves.stage"],
      ["workbench.dpm-command-center", "wave-handoff", "dpm.waves.handoff"],
      ["workbench.dpm-command-center", "wave-proof-pack", "dpm.waves.proof-pack"],
      [
        "workbench.dpm-command-center",
        "wave-supportability",
