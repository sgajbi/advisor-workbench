...
describe("canonical live validation script", () => {
  ...
  it("records demo screenshot evidence with registry-governed names, routes, and absolute paths", () => {
    ...
    expect(browserWorkflowModule).toContain("advisory-proposal-builder-live.png");
    expect(browserWorkflowModule).toContain("advisory-proposal-simulation-live.png");
    expect(browserWorkflowModule).toContain("advisory-suitability-review-live.png");
    ...
    expect(browserWorkflowModule).toContain("advisory-client-discussion-pack-live.png");
    expect(browserWorkflowModule).toContain("advisory-implementation-status-live.png");
    expect(browserWorkflowModule).toContain("workspace-evaluation-through-gateway");
    expect(browserWorkflowModule).toContain("Proposal lifecycle counts");
    expect(runbook).toContain("advisoryJourneyChecks");
    expect(runbook).toContain("Advisory Overview, Client Context, Opportunities and Ideas");
